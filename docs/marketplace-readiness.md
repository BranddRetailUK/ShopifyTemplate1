...
- [ ] Run browser automation against the exact packaged theme
...
**Not publication-ready yet.** Source and sales-package infrastructure are
being brought to release quality, but legal/name clearance, marketplace-specific
terms, a dedicated demo, exact-package platform QA, and human browser/device
evidence remain required. No unchecked item may be converted into a listing
